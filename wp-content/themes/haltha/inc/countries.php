<?php
	class WP_Region_Selector {
		...
		public static function render_region_selector() {
			...
			// get current country
			$currentCountryCode = self::get_sites_country();
			$currentCountry = ( isset( self::$countries[ strtoupper( $currentCountryCode ) ] ) ) ? self::$countries[ strtoupper( $currentCountryCode ) ] : '';
			// select with links
			$html = '<div class="select form-select">';
			$html .= '<div class="selected form-selected">';
            $html .= '<input type="text" placeholder="Country" value="' . $currentCountry . '" name="country" autocomplete="off" required readonly>';
            $html .= '<span class="error-message">';
			$html .= __( 'Error message', 'haltha' );
            $html .= '</span>';
            $html .= '</div>';
            $html .= '<div class="options form-options">';
			foreach ( self::$countries as $countryCode => $country ) {
				
				// Select current country
				$type = ( $currentCountry == strtolower( $countryCode ) ) ? ' selected' : '';
				
				$html .= '<div class="option form-option" data-option="' . $country . '">';
                $html .= '<div class="form-option-row">';
				$html .= '<div class="form-option-name">';
                $html .= $country;
                $html .= '</div>';
                $html .= '</div>';
                $html .= '</div>';
