			...
			<div class="row promo__row">
				<div class="col-md-8 promo__clip-content">
					...
					<?php if ( ! empty( $section['description'] ) ): ?>
						<p class="promo__desc wow fadeInRight"
						   data-wow-delay="500ms">
							<?php echo $section['description']; ?>
						</p>
					<?php endif; ?>
					<?php if ( ! empty( $section['button_1'] ) ): ?>
						<a href="<?php echo $section['button_1']['url']; ?>"
						   class="btn btn-secondary btn-light promo__btn wow fadeInUp"
						   data-wow-delay="1000ms"
						   target="<?php echo $section['button_1']['target']; ?>">
							<?php echo $section['button_1']['title']; ?>
						</a>
					<?php endif; ?>
					<?php if ( ! empty( $section['button_2'] ) ): ?>
						<a href="<?php echo $section['button_2']['url']; ?>"
						   class="btn btn-secondary btn-primary promo__btn wow fadeInUp"
						   data-wow-delay="1000ms"
						   target="<?php echo $section['button_2']['target']; ?>">
					...
					<div class="col-md-4 promo__clip-img">
						<picture>
							<?php if ( ! empty( $section['image_mobile'] ) ): ?>
								<source srcset="<?php echo $section['image_mobile']; ?>"
								        type="image/png"
			...
			<div class="row align-items-center why__row">
							...
							<div class="why__watch">
								<div class="watch">
									<a href="<?php echo $section['link']['url']; ?>"
									   data-fancybox
									   data-src="<?php echo $section['link']['url']; ?>"
									   class="watch__play">
										<svg width="48"
										     height="48"
										     viewBox="0 0 48 48"
				...
				<div class="col-lg-6">
					<?php if ( ! empty( $section['subtitle_highlighted'] ) || ! empty( $section['subtitle_regular'] ) ): ?>
						<h3 class="pre-title wow fadeInDown"
						    data-wow-delay="500ms">
					...
					<?php endif; ?>
					<?php if ( ! empty( $section['description'] ) ): ?>
						<p class="why__text wow fadeInUp"
						   data-wow-delay="1000ms">
							<?php echo $section['description']; ?>
						</p>
					<?php endif; ?>
		...
		<div class="container">
			<div class="row align-items-center">
				<div class="col-lg-6">
					...
					<?php endif; ?>
					<?php if ( ! empty( $section['description'] ) ): ?>
						<p class="about-info__text wow fadeInUp"
						   data-wow-delay="1000ms">
							<?php echo $section['description']; ?>
							
							<?php if ( ! empty( $section['description_link'] ) ): ?>
								<a href="<?php echo $section['description_link']['url']; ?>"
								   class="link"
								   target="<?php echo $section['description_link']['target']; ?>">
					...
					<?php if ( ! empty( $section['link'] ) ): ?>
						<a href="<?php echo $section['link']['url']; ?>"
						   class="btn btn-primary about-info__btn btn-tertiary"
		...
		<div class="container">
			<div class="bg-dark">
				<div class="join__row row">
					<div class="col-lg-6">
						<?php if ( ! empty( $section['subtitle_highlighted'] ) || ! empty( $section['subtitle_regular'] ) ): ?>
							<h3 class="pre-title join__pre-title wow fadeInDown"
							    data-wow-delay="500ms">
								<?php if ( ! empty( $section['subtitle_highlighted'] ) ): ?>
									<span>
			                    <?php echo $section['subtitle_highlighted']; ?>
				...
				<?php if ( ! empty( $section['features'] ) ): ?>
					<div class="join__list wow fadeInUp"
					     data-wow-delay="1000ms">
						<?php foreach ( $section['features'] as $key => $feature ): ?>
							<div class="join__item <?php if ( $key === 0 ) {
								echo 'active';
							} ?>">
								...
								<?php if ( ! empty( $feature['link'] ) ): ?>
									<a href="<?php echo $feature['link']['url']; ?>"
									   class="join__item-btn btn-light btn btn-secondary"
									   target="<?php echo $feature['link']['target']; ?>">
                                    <span>
	...
	<section class="studies-info">
		<div class="container">
			...
			<?php if ( ! empty( $section['studies'] ) ): ?>
				<div class="row studies-info__list wow fadeInUp"
				     data-wow-delay="1000ms">
					<?php
			...
			<?php if ( ! empty( $section['link'] ) ): ?>
				<a href="<?php echo $section['link']['url']; ?>"
				   class="btn btn-primary btn-tertiary studies-info__btn wow fadeInUp"
				   target="<?php echo $section['link']['target']; ?>">
					<?php echo $section['link']['title']; ?>
				</a>
			<?php endif; ?>
					...
					<div class="faq__categories-inner">
						<?php foreach ( $section['faqs_tabs'] as $key => $tab ): ?>
							<?php if ( ! empty( $tab['faqs_list'] ) || $key === 0 ): ?>
								<button class="btn btn-white faq__category"
								        data-category="<?php echo strtolower( sanitize_html_class( $tab['tab_title'] ) ); ?>">
