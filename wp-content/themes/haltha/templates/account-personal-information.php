			...
			<div class="row account__row">
				...
				<div class="col-md-12 col-lg-8 account__col">
					<div class="account-content">
						<div class="account-content__header wow fadeInDown">
						...
						<div class="row justify-content-center">
							<div class="col-12 not-editable-content">
								<div class="personal-information">
									<?php get_template_part( 'parts/information', 'personal' ); ?>
								</div>
								<form class="form js-change-phone">
									<input type="hidden"
									       name="action"
									       value="change_phone">
									<?php wp_nonce_field( 'change_phone' ); ?>
										...
										<div class="form__block">
											...
											<div class="row form__row">
												<div class="form__col col-6">
													<button type="button"
													        class="btn btn-gray btn-tertiary form__btn btn-prev close_edit_phone">
														<?php _e( 'Back', 'haltha' ); ?>
													</button>
												</div>
												<div class="form__col col-6">
							...
							<div class="col-lg-6 editable-content">
								<form action=""
								      class="form js-edit-personal-info">
									<?php get_template_part( 'parts/form', 'personal' ); ?>
								</form>
							</div>
						</div>
					</div>
